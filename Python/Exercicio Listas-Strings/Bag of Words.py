...
texto = '''Não tinha medo o tal João de Santo Cristo
...
print("Termos ; Frequência")
while x < len(freq):
    total = (float(num[x])/(len(lista)))*100
    # print(freq[x])
    print(f'{freq[x]} ; {num[x]}')
    x+=1